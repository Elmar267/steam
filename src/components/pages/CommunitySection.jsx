            ...
            <div className="max-w-[1150px] mx-auto px-5 py-14">
                <section className="flex flex-wrap items-center gap-5 my-5">
                    <div className="w-full md:w-[47%]">
                        <h2 className="text-[28px] sm:text-[32px] leading-[25px] font-bold mb-3">Join the<br />Community</h2>
                        <p className="text-[17px] leading-[18px] mb-3">Meet new people, join groups, form clans, chat in-game and more! With over 100 million potential friends (or enemies), the fun never stops.</p>
                ...
                <section className="flex flex-wrap items-center gap-5 my-5">
                    ...
                    <div className="w-full md:w-[47%]">
                        <h2 className="text-[28px] sm:text-[32px] leading-[25px] font-bold mb-3">Experience<br />Steam Hardware</h2>
                        <p className="text-[17px] leading-[18px] mb-3">We created the Steam Deck and the Valve Index headset to make gaming on the PC even better.</p>
                ...
                <section className="flex flex-wrap items-center gap-5 my-5">
                    <div className="w-full md:w-[47%]">
                        ...
                        <h2 className="text-[28px] sm:text-[32px] leading-[25px] font-bold mb-3">Release your<br />Game</h2>
                        <p className="text-[17px] leading-[18px] mb-3">Steamworks is the set of tools and services that help game developers and publishers get the most out of distributing games on Steam.</p>
